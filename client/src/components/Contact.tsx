...
import { MapPin, Mail, Clock, Send, Building, Headphones, Target, Loader } from 'lucide-react';
  ...
  const contactMutation = useMutation({
    ...
    onError: (error) => {
      toast({
        ...
        description: error.message || "Sorry, there was an error sending your message. Please try again later.",
        variant: "destructive",
      });
    }
  });
          ...
          <svg className="w-full h-full" viewBox="0 0 100 100" preserveAspectRatio="none">
            <defs>
              <pattern id="contactGrid" width="4" height="4" patternUnits="userSpaceOnUse">
                <circle cx="2" cy="2" r="0.5" fill="currentColor" className="text-muted-foreground/20" />
              </pattern>
            </defs>
      ...
      <div className="relative z-10 container mx-auto px-4 lg:px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className={`text-center mb-16 ${contactVisible ? 'animate-fade-in' : 'opacity-0'}`}>
            ...
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-8 text-foreground" data-testid="text-contact-title">
              Ready to <span className="text-primary">Enhance</span> 
              <span className="block">Your Institution's Success?</span>
            </h2>
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed" data-testid="text-contact-subtitle">
              Partner with VSP Technologies to enhance your institution's placement outcomes. Our team is ready to discuss customized training solutions for your students.
            </p>
          </div>

          <div className="grid lg:grid-cols-12 gap-12 items-start">
            {/* Professional Contact Information */}
            <div className={`lg:col-span-5 ${contactVisible ? 'animate-slide-in-left' : 'opacity-0'} space-y-6`}>
              {/* Professional Contact Card */}
              <div className="bg-card rounded-lg p-6 border border-border shadow-sm" data-testid="contact-info-card">
                <h3 className="text-2xl font-bold mb-6 text-foreground flex items-center" data-testid="text-contact-info-title">
                  ...
                  <div className="group" data-testid="contact-info-location">
                    <div className="bg-muted/50 rounded-lg p-4 border border-border hover:bg-muted transition-all duration-300">
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          <h4 className="text-lg font-semibold text-foreground mb-1">Institutional Headquarters</h4>
                          <p className="text-muted-foreground">Visakhapatnam, India</p>
                          <p className="text-muted-foreground text-sm">Partner Relations Office</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="group" data-testid="contact-info-email">
                    <div className="bg-muted/50 rounded-lg p-4 border border-border hover:bg-muted transition-all duration-300">
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          <h4 className="text-lg font-semibold text-foreground mb-1">Partnership Inquiries</h4>
                          <p className="text-muted-foreground">partnerships@vsptech.com</p>
                          <p className="text-muted-foreground text-sm">Dedicated institutional support</p>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="relative group overflow-hidden rounded-lg shadow-sm">
                ...
                <div className="absolute bottom-4 left-4 right-4">
                  <div className="bg-card/95 rounded-lg p-3 border border-border">
                    <p className="text-foreground font-semibold text-sm">🏢 Our Modern Campus</p>
                    <p className="text-muted-foreground text-xs">State-of-the-art facilities in the heart of Vizag</p>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-card rounded-lg p-4 text-center border border-border shadow-sm" data-testid="stat-support">
                ...
                <div className="bg-card rounded-lg p-4 text-center border border-border shadow-sm" data-testid="stat-focus">
                  <div className="w-10 h-10 bg-secondary rounded-lg flex items-center justify-center mx-auto mb-3">
                    <Target className="w-5 h-5 text-secondary-foreground" />
                  </div>
                  <div className="text-2xl font-bold text-foreground mb-1">100%</div>
                  <div className="text-muted-foreground text-sm font-medium">Success Focus</div>
                </div>
              </div>
            </div>

            {/* Professional Contact Form */}
            <div className={`lg:col-span-7 ${contactVisible ? 'animate-slide-in-right' : 'opacity-0'}`}>
              <div className="bg-card rounded-lg p-8 border border-border shadow-sm" data-testid="contact-form-card">
                <h3 className="text-2xl font-bold mb-6 text-foreground flex items-center" data-testid="text-contact-form-title">
                  <div className="w-10 h-10 bg-primary rounded-lg flex items-center justify-center mr-3">
                ...
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8" data-testid="form-contact">
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel className="text-foreground font-semibold">Organization/College</FormLabel>
                            <FormControl>
                              <Input 
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <Select onValueChange={field.onChange} defaultValue={field.value}>
                              <FormControl>
                                <SelectTrigger className="bg-background border-border text-foreground rounded-lg py-3 px-4 focus:border-primary transition-all duration-300" data-testid="select-subject">
                                  <SelectValue placeholder="What would you like to discuss?" />
                                </SelectTrigger>
                              </FormControl>
                              <SelectContent className="bg-popover border-border">
                                <SelectItem value="institutional-partnership">Institutional Training Partnership</SelectItem>
                                <SelectItem value="placement-enhancement">Placement Rate Enhancement</SelectItem>
                                <SelectItem value="customized-curriculum">Customized Training Curriculum</SelectItem>
                                <SelectItem value="lms-platform">LMS Platform Integration</SelectItem>
                                <SelectItem value="general-inquiry">General Partnership Inquiry</SelectItem>
                              </SelectContent>
                            </Select>
                            <FormMessage className="text-destructive" />
                          </FormItem>
                          ...
                          <FormItem className="flex flex-row items-start space-x-4 space-y-0">
                            ...
                            <div className="space-y-1 leading-none">
                              <FormLabel className="text-muted-foreground leading-relaxed">
                                I agree to the processing of my personal data and to be contacted by VSP Technologies regarding my inquiry. *
                              </FormLabel>
                              <FormMessage className="text-destructive" />
                            </div>
                          </FormItem>
