  ...
  return (
    <footer className="bg-white border-t border-border pt-16 md:pt-24 pb-8 md:pb-12" data-testid="footer-main">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 mb-16 md:mb-20 text-left">
          {/* Brand Identity */}
          <div className="lg:col-span-5 space-y-6 md:space-y-8">
            <div className="flex flex-col md:flex-row items-start md:space-x-4 space-y-4 md:space-y-0" data-testid="footer-logo">
            ...
            <p className="text-sm md:text-lg text-muted-foreground font-medium leading-relaxed max-w-md mx-0">
            ...
            <div className="space-y-4 pt-4 flex flex-col items-start text-left">
                ...
                {quickLinks.map((link) => (
                  <li key={link.id}>
                    <button
                      ...
                      className="text-muted-foreground font-bold text-sm hover:text-primary transition-all flex items-center group mx-0"
                    >
        ...
        {/* Legal & Credits */}
        <div className="pt-8 md:pt-12 border-t border-border/50 flex flex-col md:flex-row justify-between items-start gap-6 md:gap-8 text-left">
          <div>
            <p className="text-sm font-bold text-muted-foreground">
              © 2025 VSP Technologies Private Limited.
            </p>
            <p className="text-[10px] text-muted-foreground/60 font-medium mt-1">
              Registered in Andhra Pradesh, Amalapuram. All rights reserved.
            </p>
          </div>
          
          <div className="text-left md:text-right">
            <p className="text-sm font-bold text-muted-foreground">
              Developed by <a href="https://www.smdigitalx.com" target="_blank" rel="noopener noreferrer" className="text-primary hover:text-secondary transition-colors">SMDigitalX</a>
            </p>
            <p className="text-[10px] text-muted-foreground/60 font-medium mt-1 flex items-center justify-start md:justify-end">
              Built with Precision and <span className="text-red-500 mx-1">❤️</span> in Amalapuram
            </p>
          </div>
        </div>
      </div>
