...
export default function WhatsAppButton() {
  ...
  const handleWhatsAppClick = () => {
    ...
    const message = "Hi! I'm interested in learning more about VSP Technologies' campus recruitment training programs. Can you provide more details?";
  ...
  return (
    <>
      ...
      <div className="fixed bottom-32 right-12 z-30 pointer-events-none">
        <div className="relative">
          <div className="absolute animate-bounce" style={{animationDelay: '0s'}}>
            <div className="w-6 h-6 bg-green-100 rounded-full flex items-center justify-center opacity-70">
              <span className="text-xs">💬</span>
            </div>
          </div>
          <div className="absolute animate-bounce left-8" style={{animationDelay: '0.5s'}}>
            <div className="w-4 h-4 bg-green-200 rounded-full flex items-center justify-center opacity-60">
              <span className="text-xs">✨</span>
            </div>
          </div>
          <div className="absolute animate-bounce left-4 -top-6" style={{animationDelay: '1s'}}>
            <div className="w-5 h-5 bg-green-300 rounded-full flex items-center justify-center opacity-50">
              <span className="text-xs">📞</span>
            </div>
          </div>
        </div>
