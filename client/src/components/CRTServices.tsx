  ...
  const technicalCurriculum = [
    {
      ...
      title: "Programming",
      description:
        "One programming language (Either Java or Python) Depends on college requirement",
      color: "primary",
    },
    {
      icon: LaptopIcon,
  ...
  const learningPath = [
    {
      ...
      description:
        "Evaluate student skill levels and institutional requirements",
    ...
    },
    {
      ...
      description:
        "Deliver comprehensive training aligned with academic schedule",
      details:
        "Flexible delivery schedule that fits your institution's calendar",
      color: "secondary",
      icon: Dumbbell,
    },
    {
    ...
    },
    {
      ...
      details:
        "Detailed progress reports provided to institutional administration",
      color: "primary",
      icon: Trophy,
    },
  ];
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div
            className={`text-center mb-16 ${
              crtVisible ? "animate-fade-in" : "opacity-0"
            }`}
          >
            ...
            <p
              ...
              data-testid="text-crt-subtitle"
            >
              Partner with VSP Technologies to enhance your institution's
              placement success rate through our comprehensive CRT programs
              designed to make your students industry-ready
            </p>
          </div>

          {/* Interactive Service Showcase */}
          <div
            className={`${crtVisible ? "animate-fade-in" : "opacity-0"} mb-24`}
            style={{ animationDelay: "0.2s" }}
          >
            <div
              className="grid lg:grid-cols-3 gap-12 items-start"
              data-testid="main-crt-services"
            >
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        <div className="flex-1">
                          <h4
                            ...
                            data-testid={`main-service-title-${index + 1}`}
                          >
                            {service.title}
                          </h4>
                ...
                <div className="bg-card rounded-xl p-8 shadow-lg border border-border">
                    ...
                    {(() => {
                      ...
                      return (
                        <div className="mr-4">
                          <IconComponent
                            className={`w-10 h-10 ${
                              mainServices[activeService].color === "primary"
                                ? "text-primary"
                                : mainServices[activeService].color ===
                                  "secondary"
                                ? "text-secondary"
                                : "text-accent"
                            }`}
                  ...
                  <div className="mb-6">
                    <img
                      ...
                      alt={`${mainServices[activeService].title} illustration`}
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div className="rounded-lg p-4 border border-secondary/20">
                      ...
                      <p className="text-muted-foreground text-sm">
                        Curriculum aligned with current market requirements
                      </p>
                    </div>
          ...
          <div
            className={`${crtVisible ? "animate-fade-in" : "opacity-0"} mb-16`}
            style={{ animationDelay: "0.4s" }}
          >
            <div className="text-center mb-12">
              <h3
                className="text-3xl font-bold text-foreground mb-4 flex items-center justify-center"
                data-testid="text-technical-curriculum-title"
              >
                Technical Excellence Program
              </h3>
              <p className="text-base text-muted-foreground">
                Master cutting-edge technologies with hands-on experience
              </p>
            </div>

            <div
              className="grid md:grid-cols-3 lg:grid-cols-5 gap-6"
              data-testid="technical-curriculum-grid"
            >
                  ...
                  >
                    <div className="bg-card rounded-lg p-6 shadow-sm border border-border transition-all duration-300 hover:shadow-md">
                      ...
                      <h4
                        ...
                        data-testid={`technical-item-title-${index + 1}`}
                      >
                        {item.title}
                      </h4>
                      <p
                        className="text-muted-foreground text-sm text-center leading-relaxed"
                        data-testid={`technical-item-description-${index + 1}`}
                      >
                        {item.description}
                      </p>
                    </div>
          ...
          {/* <div
            className={`${crtVisible ? "animate-fade-in" : "opacity-0"}`}
            style={{ animationDelay: "0.6s" }}
          >
            <div className="bg-primary rounded-xl p-8 md:p-12 text-primary-foreground">
              <h3
                className="text-3xl font-bold text-center mb-4"
                data-testid="text-learning-path-title"
              >
                Our Training <span className="text-secondary">Methodology</span>
              </h3>
              <p className="text-lg text-center text-primary-foreground/90 mb-8">
                A proven systematic approach that consistently delivers improved
                placement outcomes for partner institutions
              </p>
              ...
              >
                {learningPath.map((step, index) => {
                  ...
                  return (
                    ...
                    >
                      <div
                        className={`bg-primary-foreground/10 rounded-lg p-6 text-center border border-primary-foreground/20 transition-all duration-300 ${
                          activeStep === index
                      ...
                      >
                        ...
                        <h4
                          ...
                          data-testid={`learning-step-title-${step.step}`}
                        >
                          {step.title}
                        </h4>
                        <p
                          className="text-primary-foreground/90 mb-2 text-sm"
                          data-testid={`learning-step-description-${step.step}`}
                        >
                          {step.description}
                        </p>
                        <p
                          className={`text-primary-foreground/80 text-xs transition-all duration-300 ${
